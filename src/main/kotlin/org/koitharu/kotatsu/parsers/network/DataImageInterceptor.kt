 ...
 */
public fun Element.dataImageAsUrl(attr: String): String {
 ...
 */
public fun Element.dataImageAsUrlOrNull(attr: String): String? {
    return if (this.attr(attr).startsWith("data")) {
        "https://127.0.0.1/?" + this.attr(attr).substringAfter(":")
    } else {
        null
 ...
 */
public class DataImageInterceptor : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        return if (url.startsWith("https://127.0.0.1/?image")) {
            ...
            val byteArray = if (dataString.contains("base64")) {
                Base64.getDecoder().decode(dataString.substringAfter("base64,"))
            } else {
